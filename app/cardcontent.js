...
// Lo que pasa cuando nos eligen
export const chooseUs = [
  {
    icon: "/icon/blob.svg",
    title: 'Experiencia creativa',
    description: 'Diseños únicos adaptados a tu marca, cautivando a los usuarios con imágenes innovadoras.'
  },
  {
    icon: '/icon/wrench.svg',
    title: 'Instalaciones a la medida',
    description: 'No te preocupes por referencias técnicas, tú solo enfócate en tu negocio.'
  },
  {
    icon: '/icon/check.svg',
...
// Lo que pasa cuando no nos eligen
